...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Validar se a planilha existe e está ativa
        ...
        // Habilitar modo público com contexto da planilha
        ...
        header('Location: ../app/views/shared/menu-unificado.php?contexto=planilha&id=' . urlencode($planilha['id']) . '&publico=1');
        exit;
...
<head>
    ...
    <style>
        ...
        .box { max-width: 420px; width:100%; background:#fff; border-radius:16px; box-shadow:0 10px 40px rgba(0,0,0,.2); overflow:hidden; }
