...
// Apenas incluir autenticaÃ§Ã£o se NÃƒO for registro pÃºblico
if (!defined('PUBLIC_REGISTER')) {
    ...
    // Registro pÃºblico - iniciar sessÃ£o se nÃ£o existir
    if (session_status() === PHP_SESSION_NONE) {
        session_start();
    }
    
    // Definir funÃ§Ãµes auxiliares caso nÃ£o estejam disponÃ­veis
...
$(document).ready(function() {
    ...
    rgInput.addEventListener('input', function(){
        if (document.getElementById('rg_igual_cpf').checked) return; // quando igual CPF nÃ£o formata manual
