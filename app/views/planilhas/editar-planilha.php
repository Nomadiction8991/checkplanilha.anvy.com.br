            ...
            <div class="row g-3">
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" id="nome_responsavel" name="nome_responsavel" 
                           value="<?php echo htmlspecialchars($planilha['nome_responsavel'] ?? ''); ?>" maxlength="255">
                </div>
            </div>
...
function drawImageOnCanvas(canvasId, dataUrl) {
    ...
    const img = new Image();
    img.onload = function() {
        // Redimensionar mantendo proporcionalidade, centralizando
        ctx.clearRect(0,0,c.width,c.height);
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    // Antes do submit, serializar os canvases para os hidden inputs
