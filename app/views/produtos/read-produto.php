                  ...
                  <div class="flex-grow-1">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      ...
                      <div class="btn-group btn-group-sm">
                        <a class="btn btn-outline-primary btn-sm" title="Editar" href="./update-produto.php?id_produto=<?php echo $produto['id']; ?>&comum_id=<?php echo $comum_id; ?>&<?php echo gerarParametrosFiltro(true); ?>">
      ...
      <nav>
        <ul class="pagination justify-content-center mb-0">
          ...
          <?php if ($pagina < $total_paginas - 1): ?>
            <li class="page-item">
              <a class="page-link" href="?comum_id=<?php echo $comum_id; ?>&pagina=<?php echo $total_paginas; ?>&<?php echo gerarParametrosFiltro(); ?>" aria-label="Última">
                <span aria-hidden="true">»</span>
              </a>
            </li>
          <?php endif; ?>
