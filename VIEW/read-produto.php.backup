                    ...
                    <tr>
                        ...
                        <td class="centered">
                            <div class="acoes-container">
                                <!-- CORREÇÃO: mudar para 'id' -->
                                <a href="update-produto.php?id_produto=<?php echo $produto['id']; ?>&id=<?php echo $id_planilha; ?>&<?php echo gerarParametrosFiltro(true); ?>" class="btn-acao btn-editar">
                                ...
                                <!-- CORREÇÃO: mudar para 'id' -->
                                <a href="delete-produto.php?id_produto=<?php echo $produto['id']; ?>&id=<?php echo $id_planilha; ?>&<?php echo gerarParametrosFiltro(true); ?>" class="btn-acao btn-excluir">
