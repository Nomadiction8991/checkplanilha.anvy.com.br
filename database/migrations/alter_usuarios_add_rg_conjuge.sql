...
ALTER TABLE usuarios
    ADD COLUMN rg VARCHAR(50) NULL AFTER cpf,
    ...
    ADD COLUMN rg_conjuge VARCHAR(50) NULL AFTER cpf_conjuge,
    ADD COLUMN rg_conjuge_igual_cpf TINYINT(1) NOT NULL DEFAULT 0 AFTER rg_conjuge,
    ADD COLUMN telefone_conjuge VARCHAR(20) NULL AFTER rg_conjuge_igual_cpf,
...
CREATE INDEX idx_usuarios_rg_conjuge ON usuarios (rg_conjuge);